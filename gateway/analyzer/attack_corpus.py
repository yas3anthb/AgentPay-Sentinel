...
INTENT_CLUSTERS: dict[str, list[set[str]]] = {
    ...
    "redirect_funds": [
        {"route", "reroute", "redirect", "forward", "send", "transfer",
         "divert", "move", "pay", "deliver", "wire", "remit", "goes", "go",
         "going", "payout", "disburse", "settle"},
        {"payment", "funds", "fund", "money", "transaction", "checkout",
         "amount", "charge", "settlement", "payout", "disbursement"},
    ...
    "raise_limits": [
        {"raise", "raised", "raising", "increase", "increased", "lift", "lifted",
         "remove", "exceed", "ignore", "bypass", "override", "disable", "extend",
         "expand", "boost", "relax", "loosen", "widen", "widened", "wider",
         "waive", "waived", "waiving", "suspend", "higher"},
        {"limit", "limits", "budget", "cap", "caps", "ceiling", "threshold",
         "maximum", "allowance", "allowances", "restriction"},
    ],
    "exfiltrate_secrets": [
