...
request
  ...
  ├─ 3 analyzer        needs: Groq (classifier)   — degrades, never blocks the request itself
...
`groq_timeout_seconds` (default 4s) plus the circuit breaker bound its
worst case.
